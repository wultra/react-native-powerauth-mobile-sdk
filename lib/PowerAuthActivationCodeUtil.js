 ...
 */
var PowerAuthActivationCodeUtil = /** @class */ (function () {
    function PowerAuthActivationCodeUtil() {
    }
    /**
     ...
     */
    PowerAuthActivationCodeUtil.parseActivationCode = function (activationCode) {
     ...
     * @throws error when not valid
     */
    PowerAuthActivationCodeUtil.parseRecoveryCode = function (recoveryCode) {
     ...
     */
    PowerAuthActivationCodeUtil.validateActivationCode = function (activationCode) {
     ...
     */
    PowerAuthActivationCodeUtil.validateRecoveryCode = function (recoveryCode) {
     ...
     */
    PowerAuthActivationCodeUtil.validateRecoveryPuk = function (puk) {
     ...
     */
    PowerAuthActivationCodeUtil.validateTypedCharacter = function (character) {
     ...
     * - '1' is corrected to 'I'
     */
    PowerAuthActivationCodeUtil.correctTypedCharacter = function (character) {
        return __NativeWrapper.call("correctTypedCharacter", character);
    };
    return PowerAuthActivationCodeUtil;
}());
export { PowerAuthActivationCodeUtil };
