...
var PowerAuthTokenStore = /** @class */ (function () {
     ...
     */
    PowerAuthTokenStore.hasLocalToken = function (tokenName) {
     ...
     */
    PowerAuthTokenStore.getLocalToken = function (tokenName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, NativeModules.PowerAuth.getLocalToken(tokenName)];
            });
        });
    };
    /**
     ...
     */
    PowerAuthTokenStore.removeLocalToken = function (tokenName) {
     ...
     */
    PowerAuthTokenStore.removeAllLocalTokens = function () {
     ...
     */
    PowerAuthTokenStore.requestAccessToken = function (tokenName, authentication) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _c = [tokenName];
                        return [4 /*yield*/, __AuthenticationUtils.process("TODO", authentication)];
     ...
     */
    PowerAuthTokenStore.removeAccessToken = function (tokenName) {
     ...
     */
    PowerAuthTokenStore.generateHeaderForToken = function (tokenName) {
        return NativeModules.PowerAuth.generateHeaderForToken(tokenName !== null && tokenName !== void 0 ? tokenName : "");
    };
