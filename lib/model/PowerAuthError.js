...
(function (PowerAuthErrorCode) {
    ...
    PowerAuthErrorCode["PA2RNInstanceNotConfigured"] = "PA2RNInstanceNotConfigured";
    /** Error in `correctTypedCharacter` */
    PowerAuthErrorCode["PA2RNInvalidCharacter"] = "PA2RNInvalidCharacter";
    /** Used invalid recovery code in parseRecoveryCode */
    PowerAuthErrorCode["PA2RNInvalidRecoveryCode"] = "PA2RNInvalidRecoveryCode";
    /** Used invalid recovery code in parseActivationCode */
    PowerAuthErrorCode["PA2RNInvalidActivationCode"] = "PA2RNInvalidActivationCode";
    /** Error when generating a token */
    PowerAuthErrorCode["PA2RNTokenNotAvailable"] = "PA2RNTokenNotAvailable";
    /** Error when generating a token */
    PowerAuthErrorCode["PA2RNCannotGenerateHeader"] = "PA2RNTokenNotAvailable";
    /** Error when requesting local token */
    PowerAuthErrorCode["PA2RNLocalTokenNotAvailable"] = "PA2RNLocalTokenNotAvailable";
    /** Biometric authentication failed */
    PowerAuthErrorCode["PA2RNBiometryFailed"] = "PA2RNBiometryFailed";
    /** When users cancel biometry dialog  */
    PowerAuthErrorCode["PA2RNBiometryCanceled"] = "PA2RNBiometryCanceled";
    /** When password is not set during activatio ncommit */
    PowerAuthErrorCode["PA2RNPasswordNotSet"] = "PA2RNPasswordNotSet";
    /** Error when invalid activatio object is provided during activation */
    PowerAuthErrorCode["PA2RNInvalidActivationObject"] = "PA2RNInvalidActivationObject";
