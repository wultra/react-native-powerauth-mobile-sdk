...
PA_EXTERN_C NSString * __nonnull const EC_WRONG_SIGNATURE;
...
PA_EXTERN_C NSString * __nonnull const EC_UPGRADE_SDK;
...
PA_EXTERN_C NSString * __nonnull const EC_OTHER;
...
PA_EXTERN_C NSString * __nonnull const EC_EXTERNAL_PENDING_OPERATION;
PA_EXTERN_C NSString * __nonnull const EC_INVALID_LOG_LEVEL;
PA_EXTERN_C NSString * __nonnull const EC_TIME_SYNCHRONIZATION;
